...
application.add_handler(CommandHandler("add_except_user", add_except_user))
application.add_handler(CommandHandler("remove_except_user", remove_except_user))
application.add_handler(CommandHandler("show_except_user", show_except_users))
